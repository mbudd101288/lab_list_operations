...
def tail(input_list):
    ...
    """
    # input_list.remove(input_list[0]) - quicker to pop at an index
    # removed_item = input_list.pop(0) - this will modify in place - not return a new list
    other_new = input_list[1:]
    return other_new
